...
requirements = python3==3.11.11,hostpython3==3.11.11,kivy,asynckivy,
    asyncgui,sjfirebase,sdl2==2.30.11,sdl2_mixer==2.8.0,sdl2_ttf==2.24.0,sdl2_image==2.8.4,libffi==v3.4.6,
...
android.gradle_dependencies = io.github.simplejnius:sjfirebase:1.3.0,
    ...
    androidx.appcompat:appcompat:1.7.0,com.android.billingclient:billing:7.1.1
